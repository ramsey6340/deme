...
class CauseRadioCard extends StatelessWidget {
  const CauseRadioCard({super.key, required this.cause, this.checkBoxValue=false, required this.onChangedCheckBoxValue});
  final Cause cause;
