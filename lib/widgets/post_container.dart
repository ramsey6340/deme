              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                            snapshot.data!.activity.assignment.organization
                                .imageUrl!),
                      ),
                      SizedBox(
                          ...
                          Text.rich(
                            TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text:
                                      '\n@${snapshot.data!.activity.assignment
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      (snapshot.data!.imageUrls.isNotEmpty &&
                          snapshot.data!.imageUrls[0].isNotEmpty)
                          ? const SizedBox(height: 15)
                          : const SizedBox(),
                      (snapshot.data!.imageUrls.isNotEmpty &&
                          snapshot.data!.imageUrls[0].isNotEmpty) ?
                      Container(
                        height: (snapshot.data!.imageUrls.isNotEmpty)
                            ? getProportionateScreenHeight(200)
                            : 0,
                        width: double.infinity,
                        decoration: (snapshot.data!.imageUrls.isNotEmpty)
                            ? BoxDecoration(
                            color: kPrimaryColor,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      (snapshot.data!.imageUrls.isNotEmpty && snapshot.data!.imageUrls[0].isNotEmpty)?const SizedBox(height: 15):const SizedBox(),
