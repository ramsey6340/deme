...
class SettingAssignment extends StatefulWidget {
  static String routeName = '/setting_assignment';
...
class _SettingAssignmentState extends State<SettingAssignment> {
  ...
  final formKeyAssignment = GlobalKey<FormState>();
              ...
              Center(
                child: AsyncTextBtn(
                  ...
                  onPressed: () async {
                    ...
                    if (formKeyAssignment.currentState!.validate()) {
                      formKeyAssignment.currentState!.save();
                      try {
    ...
    AnimatedButton(
      ...
      pressEvent: () {
        AwesomeDialog(
          ...
          headerAnimationLoop: false,
          title: 'Erreur',
          desc: "Une erreur s'est produit lors de la création de la mission",
          btnOkOnPress: () {},
