...
class _ProfilePageState extends State<ProfilePage> {
  //List<Widget> accountPages = [Setting(), LastPost(organizationId: widget.organization.organizationId!), LastDonation()];
  ...
  build(BuildContext context) {
    return DefaultTabController(
      length: [Setting(), LastPost(organizationId: widget.organization.organizationId!), LastDonation(organizationId: widget.organization.organizationId!,)].length,
      child: Scaffold(
        //appBar: AppBar(),
        body: Container(
          ...
          child: CustomScrollView(slivers: [
            ...
            SliverFillRemaining(
              child: TabBarView(
                children: [Setting(), LastPost(organizationId: widget.organization.organizationId!), LastDonation(organizationId: widget.organization.organizationId!,)],
              ),
            ),
          ]),
        ),
